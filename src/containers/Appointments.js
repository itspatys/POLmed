...
const Appointments = (props) => {
    ...
    return(
        <div className="appointments-container">
            <div className="appointments-heaning">Wybierz interesujący Cię dzień spośród najbliższych trzech dni roboczych:</div>
                    ...
                    return (
                        <div 
                            ...
                            onClick={()=>{
                                ...
                                const newHoursState = []
                                for (const [key, value] of Object.entries(appointments[index])){
            ...
            <div className="appointments-hours">
                {
                    hours.map((hour, index) => {
                        return (
                            <div key={`key${index}`} className={(hour[1] == false ? "appointments-hours-not-avail" : "") + (hour[0] == chosenHour ? "appointments-hours-selected" : "")}
                                onClick={()=>{setChosenHour(hour[0])}}
                            >{hour[0]}</div>
                        )
                    })
                }
            ...
            <div className="appointments-pricing">
                {
                    services.map((service,index) => {
                        return <div
                            ...
                            key={`service${index}`}
                            className={
                                (service[0] == "Ładowanie..." ? "appointments-pricing-not-avail " : "" ) +
            ...
            <button disabled={chosenHour != "00:00" && chosenService != -1 && chosenDay != -1 ? false : true}>
